      ...
      for (const [p, player] of [team.player["1"]].entries()) {
        if (player) {
          ...
          SetInnerHtml(
            ...
            `${team.losers ? "<span class='losers'>[L]</span>" : ""}` //String('[L]' fonctionne mais n'as pas de css
          );
          ...
          SetInnerHtml($(`.score_container .p${t + 1}`), String(team.score));
          SetInnerHtml(
